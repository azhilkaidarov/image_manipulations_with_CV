...
- Add CLI arguments (`--input`, `--output`, `--config`) instead of hardcoding in `main.py`;
- add before/after visualization in one view;
- add unit tests for every manipulation;
- add batch mode for all images in `data/raw`.
